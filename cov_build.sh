...
############################
# Build entservices-screencapture
echo "======================================================================================"
echo "buliding entservices-screencapture"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-screencapture \
-DUSE_THUNDER_R4=ON \
...
-DDISABLE_SECURITY_TOKEN -DUSE_THUNDER_R4 -DTHUNDER_VERSION=4 -DTHUNDER_VERSION_MAJOR=4 -DTHUNDER_VERSION_MINOR=4" \

cmake --build build/entservices-screencapture --target install
echo "======================================================================================"
exit 0
