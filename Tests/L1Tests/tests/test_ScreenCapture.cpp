...
TEST_F(ScreenCaptureDRMTest, UploadFromVNC)
{   
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("uploadScreenCapture"), _T("{\"url\":\"http://127.0.0.1:11110\"}"), response));
